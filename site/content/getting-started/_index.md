...
description = "Run the core dvs workflow on a small dataset, from R or the CLI."
+++
...
[CLI](@/cli/_index.md) sections document every function and command (the R
Package section also covers the R-only helper utilities), and
