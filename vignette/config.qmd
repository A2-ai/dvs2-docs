...
#| warning: false
setwd(new_project)
mkdatasetfiles(n_files = 5, size_mb = 5, prefix = "file_", dir = "data")
dvs_init(storage)
```
...
#| warning: false
setwd(project_zstd)
mkdatasetfiles(n_files = 5, size_mb = 10, prefix = "data_", dir = "data")
```
...
#| warning: false
setwd(project_t)
mkdatasetfiles(n_files = 50, size_mb = 3, prefix = "f_", dir = "data")
dvs_init(storage_t)
```
...
#| warning: false
setwd(project_m)
mkdatasetfiles(n_files = 1, size_mb = 1, prefix = "d_", dir = "data")
